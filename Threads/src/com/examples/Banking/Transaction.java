...
public class Transaction {
    public static void main(String[] args) {
        BankAccount2 account1 = new BankAccount2("12345-678", 500.00);
        BankAccount2 account2 = new BankAccount2("98765-432", 1000.00);
...
class BankAccount2 {
    ...
    public boolean transfer(BankAccount2 destinationAccount, double amount) {
        if (withdraw(amount)) {
...
class Transfer implements Runnable {
    ...
    Transfer(BankAccount2 sourceAccount, BankAccount2 destinationAccount, double amount) {
